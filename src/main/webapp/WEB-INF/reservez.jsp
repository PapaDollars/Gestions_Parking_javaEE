...
<div class="">
		...
		<div class="row p-5" >
			...
			<div class="col">
				...
				<h3 class="text-success">Ajouter une Reservation</h3>
				
				
				<div class="mt-5 pt-5">
				
				
					<form method="post" action="reservez">z
					<div class="form-group">
					      <input type="text" class="form-control" name="nom_conducteur" placeholder="Nom conducteur : abdel" required>
					   </div> <br>
					   <div class="form-group">
					      <input type="text" class="form-control" name="phone_conducteur" placeholder="Contact conducteur : 690989900" required>
					   </div> <br>
					    <div class="form-group">
						     <select class="form-select"  name="code_parking" aria-label="Default select example">
							  <optgroup label="Codes parking">
							     <c:forEach var="pk"  items="${ pk }">
									  <option value="${ pk.code_parking }"> ${ pk.code_parking }</option>
						        </c:forEach>
							  </optgroup>
					   ...
					   <div class="form-group">
					      <input type="date" class="form-control" name="date_entre" min="2023-07-03" placeholder="Date entree : 10/01/1201" required>
					   </div> <br>
					  <div class="form-group">
							   <select class="form-select" name="heure_entre" size="5" aria-label="size 3 select example">
								  ...
								  <option value="06h00" selected>06h00</option>
					   ...
					   <div class="form-group">
					      <input type="text" class="form-control" name="tarif" placeholder="Tarifs (fcfa): 4000" required>
					   </div> <br>
					  ...
					  <div class="modal-dialog">
					    <div class="modal-content">
					      <div class="modal-header">
					        <h5 class="modal-title" id="exampleModalLabel"> <span class="text-success"> RESERVATION </span> </h5>
					        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
					      </div>
					      <div class="modal-body">
					       	Voulez-vous  <span class="text-success fs-4">reservez</span>  ce parking ?
					      </div>
