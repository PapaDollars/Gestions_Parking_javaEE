	...
	<div class="container-fluide m-4">
		...
		<div class="row p-5" >
			...
			<div class="col">
				...
				<h3 class="text-success">Ajouter un Espace de Parking</h3>
					...
					<form method="post" action="ajouterParking">
					  <div class="form-group">
					    ...
					    <div class="form-group">
					      ...
					      <input type="text" class="form-control" name="code_parking" id="code_parking" placeholder="exemple : P1" required>
					   </div> <br>
					   <div class="form-group">
					  ...
					  <button type="button" class="btn btn-warning bold-btn fs-5 mt-5 p-2 text-black" data-bs-toggle="modal" data-bs-target="#exampleModal">Ajouter maintenant</button> 				
					<!-- Modal -->
					  ...
					  <div class="modal-dialog">
					    <div class="modal-content">
					      <div class="modal-header">
					        <h5 class="modal-title" id="exampleModalLabel"> <span class="text-success"> CONFIRMATION AJOUT </span> </h5>
					        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
					      </div>
					      <div class="modal-body">
					       	Etes vous sur de vouloir <span class="text-success fs-4">ajouter </span>  ce parking ?
					      </div>
